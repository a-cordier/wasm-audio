...
import {
  VoiceManager,
  createNativeVoiceGenerator,
  createVoiceGenerator,
} from "../core/voice-manager";
    ...
    return html`
      <div class="content">
        ...
        <div class="control-panel">
          <knob-element
            label="attack"
            @change="${this.onAmplitudeAttackChange}"
            .shouldMidiLearn="${this.shouldMidiLearn}"
            .value="${this.amplitudeEnvelope.attack}"
          ></knob-element>
          <knob-element
            label="decay"
            @change="${this.onAmplitudeDecayChange}"
            .shouldMidiLearn="${this.shouldMidiLearn}"
            .value="${this.amplitudeEnvelope.decay}"
          ></knob-element>
          <knob-element
            label="sustain"
            @change="${this.onAmplitudeSustainChange}"
            .shouldMidiLearn="${this.shouldMidiLearn}"
            .value="${this.amplitudeEnvelope.sustain}"
          ></knob-element>
          <knob-element
            label="release"
            @change="${this.onAmplitudeReleaseChange}"
            .shouldMidiLearn="${this.shouldMidiLearn}"
            .value="${this.amplitudeEnvelope.release}"
          ></knob-element>
          <knob-element
            label="cutoff"
          ...
          <knob-element
            label="envelope"
            @change="${this.onCutoffEnvelopeAmountChange}"
            .shouldMidiLearn="${this.shouldMidiLearn}"
            .value="${this.cutoffEnvelope.amount}"
          ></knob-element>
          <knob-element
            label="attack"
            @change="${this.onCutoffAttackChange}"
            .shouldMidiLearn="${this.shouldMidiLearn}"
            .value="${this.cutoffEnvelope.attack}"
          ></knob-element>
          <knob-element
            label="decay"
            @change="${this.onCutoffDecayChange}"
            .shouldMidiLearn="${this.shouldMidiLearn}"
            .value="${this.cutoffEnvelope.decay}"
          ></knob-element>
        </div>
