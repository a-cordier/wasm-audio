...
export const MonologPresetOptions = new SelectOptions([
  ...
  },
  {
    ...
    value: {
      ...
      filter: { model: { value: 1 }, cutoff: { value: 25 }, resonance: { value: 127 }, drive: { value: 45 } },
  ...
  },
  {
    ...
    value: {
      ...
      filter: { model: { value: 0 }, cutoff: { value: 45 }, resonance: { value: 32 }, drive: { value: 50 } },
      ampEnv: { attack: { value: 3 }, decay: { value: 70 }, sustain: { value: 60 }, release: { value: 30 } },
      filterEnv: { attack: { value: 0 }, decay: { value: 55 }, amount: { value: 50 }, velocity: { value: 50 } },
  ...
  },
  {
    name: "WOBBLE",
    value: {
      osc: { mode: { value: 3 }, pulseWidth: { value: 63.5 }, subLevel: { value: 70 }, noiseLevel: { value: 0 } },
      filter: { model: { value: 0 }, cutoff: { value: 40 }, resonance: { value: 0 }, drive: { value: 40 } },
  ...
  },
  {
    name: "SCHNEK",
    value: {
      osc: { mode: { value: 1 }, pulseWidth: { value: 63.5 }, subLevel: { value: 127 }, noiseLevel: { value: 0 } },
      filter: { model: { value: 2 }, cutoff: { value: 30 }, resonance: { value: 15 }, drive: { value: 60 } },
