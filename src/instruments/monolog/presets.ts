...
export const MonologPresetOptions = new SelectOptions([
  {
    ...
    value: {
      ...
      filter: { model: { value: 0 }, cutoff: { value: 45 }, resonance: { value: 30 }, drive: { value: 35 } },
  ...
  },
  {
    name: "SUB BASS",
    value: {
      osc: { mode: { value: 1 }, pulseWidth: { value: 63.5 }, subLevel: { value: 100 }, noiseLevel: { value: 0 } },
      filter: { model: { value: 0 }, cutoff: { value: 40 }, resonance: { value: 10 }, drive: { value: 10 } },
  ...
  },
  {
    ...
    value: {
      ...
      filter: { model: { value: 1 }, cutoff: { value: 25 }, resonance: { value: 75 }, drive: { value: 45 } },
      ampEnv: { attack: { value: 0 }, decay: { value: 55 }, sustain: { value: 0 }, release: { value: 10 } },
      filterEnv: { attack: { value: 0 }, decay: { value: 45 }, amount: { value: 85 }, velocity: { value: 70 } },
      lfo: { mode: { value: 0 }, rate: { value: 10 }, amount: { value: 0 }, destination: { value: 1 } },
  ...
  },
  {
    ...
    value: {
      ...
      filter: { model: { value: 0 }, cutoff: { value: 60 }, resonance: { value: 30 }, drive: { value: 40 } },
  ...
  },
  {
    ...
    value: {
      ...
      filter: { model: { value: 0 }, cutoff: { value: 45 }, resonance: { value: 60 }, drive: { value: 50 } },
  ...
  },
  {
    ...
    value: {
      ...
      filter: { model: { value: 2 }, cutoff: { value: 55 }, resonance: { value: 70 }, drive: { value: 80 } },
  ...
  },
  {
    ...
    value: {
      ...
      filter: { model: { value: 0 }, cutoff: { value: 40 }, resonance: { value: 50 }, drive: { value: 40 } },
  ...
  },
  {
    ...
    value: {
      osc: { mode: { value: 1 }, pulseWidth: { value: 63.5 }, subLevel: { value: 0 }, noiseLevel: { value: 0 } },
      filter: { model: { value: 1 }, cutoff: { value: 15 }, resonance: { value: 90 }, drive: { value: 55 } },
      ampEnv: { attack: { value: 0 }, decay: { value: 40 }, sustain: { value: 0 }, release: { value: 8 } },
      filterEnv: { attack: { value: 0 }, decay: { value: 30 }, amount: { value: 100 }, velocity: { value: 90 } },
      lfo: { mode: { value: 0 }, rate: { value: 10 }, amount: { value: 0 }, destination: { value: 1 } },
  ...
  },
  {
    name: "DEEP DUB",
    value: {
      osc: { mode: { value: 1 }, pulseWidth: { value: 63.5 }, subLevel: { value: 90 }, noiseLevel: { value: 0 } },
      filter: { model: { value: 0 }, cutoff: { value: 50 }, resonance: { value: 25 }, drive: { value: 20 } },
  ...
  },
  {
    name: "SCREAMER",
    value: {
      osc: { mode: { value: 1 }, pulseWidth: { value: 63.5 }, subLevel: { value: 20 }, noiseLevel: { value: 0 } },
      filter: { model: { value: 2 }, cutoff: { value: 30 }, resonance: { value: 95 }, drive: { value: 60 } },
      ampEnv: { attack: { value: 0 }, decay: { value: 45 }, sustain: { value: 0 }, release: { value: 12 } },
      filterEnv: { attack: { value: 0 }, decay: { value: 35 }, amount: { value: 95 }, velocity: { value: 80 } },
      lfo: { mode: { value: 0 }, rate: { value: 10 }, amount: { value: 0 }, destination: { value: 1 } },
      performance: { glide: { value: 25 }, legato: { value: 0 } },
    } as MonologState,
  },
  {
    name: "MS-20 RIPPER",
    value: {
      osc: { mode: { value: 1 }, pulseWidth: { value: 63.5 }, subLevel: { value: 50 }, noiseLevel: { value: 0 } },
      filter: { model: { value: 3 }, cutoff: { value: 35 }, resonance: { value: 85 }, drive: { value: 70 } },
      ampEnv: { attack: { value: 0 }, decay: { value: 55 }, sustain: { value: 60 }, release: { value: 20 } },
      filterEnv: { attack: { value: 0 }, decay: { value: 40 }, amount: { value: 80 }, velocity: { value: 60 } },
      lfo: { mode: { value: 0 }, rate: { value: 10 }, amount: { value: 0 }, destination: { value: 1 } },
      performance: { glide: { value: 20 }, legato: { value: 0 } },
    } as MonologState,
  },
]);
