...
const BYTES_PER_UNIT = Uint16Array.BYTES_PER_ELEMENT; // 2
...
class HeapAudioBuffer {
   ...
   */
  constructor(wasm, length, channelCount, maxChannelCount) {
   ...
   */
  _allocateHeap() {
    const channelByteSize = this._length * BYTES_PER_SAMPLE; // 512
    const dataByteSize = this._maxChannelCount * channelByteSize; // 1024
